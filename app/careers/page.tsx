...
const CareersPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-credera-dark text-white py-20">
          ...
          <div className="flex flex-col xl:flex-row gap-8">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <button
                        ...
                        className="text-credera-red font-medium hover:text-red-700 transition-colors duration-200 relative group"
                      >
                        View More
                    ...
                    <div className="ml-8">
                      <button
                        ...
                        className="bg-credera-red text-white px-8 py-3 rounded-md hover:bg-red-700 transition-colors duration-200 font-semibold"
                      >
                        Apply
                      </button>
                    </div>
                ...
                >
                  <div className="px-8 pb-8 border-t border-gray-100">
                    <div className="pt-6 space-y-6">
                      {/* Job Description */}
                      <div>
                        <h4 className="text-lg font-semibold text-credera-dark mb-3">
                          About This Role
                        </h4>
            ...
            <div className="xl:w-96 xl:block hidden">
              <div className="bg-gray-50 rounded-lg p-8 sticky top-8">
                <h3 className="text-2xl font-bold text-credera-dark mb-8">Why Join Us?</h3>
                
                <div className="space-y-8">
                  <div>
                    <div className="w-16 h-16 bg-credera-red rounded-full flex items-center justify-center mb-4">
                      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 005.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                      </svg>
                    </div>
                    <h4 className="text-xl font-bold text-credera-dark mb-3">
